        ...
        <div ref="modalContent" class="bg-white rounded-md shadow-lg overflow-auto max-w-md w-full max-h-full">
          ...
          <div class="px-5 py-3">
            <div class="flex flex-col">
              ...
              <div class="flex justify-center text-green-400 mb-1">
          ...
          <div class="flex h-9 mt-6 mb-8 justify-center">
            <button type="button" @click.stop="$emit('close-modal')"
                    class="w-20 text-white text-base rounded-md bg-green-500 hover:bg-green-600 transition ease-in duration-200">
              OK
            </button>
          </div>
        </div>
